...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO `class` (classID, classname) VALUES (%s, %s)",
...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form2")) {
  $insertSQL = sprintf("INSERT INTO stream (streamID, streamname, classID) VALUES (%s, %s, %s)",
...
<table width="100%" height="400" bgcolor="#ffffff">
  <tr>
    <td><fieldset><legend align="center">Enter class details</legend>
        <form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
          <table align="center">
            <tr valign="baseline">
              <td nowrap="nowrap" align="right">ClassID:</td>
              <td><input type="text" name="classID" value="" size="32" /></td>
            </tr>
            <tr valign="baseline">
              <td nowrap="nowrap" align="right">Classname:</td>
              <td><input type="text" name="classname" value="" size="32" /></td>
            </tr>
            <tr valign="baseline">
    ...
    <td><fieldset><legend align="center">Enter streams</legend>
