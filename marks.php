...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO marks (marksID, examID, admino, score, subjectcode, termID) VALUES (%s, %s, %s, %s, %s, %s)",
                       GetSQLValueString($_POST['marksID'], "text"),
                       ...
                       GetSQLValueString($_POST['termID'], "text"));
...
<table width="100%" height="400" bgcolor="#ffffff">
  <tr>
    <td><fieldset>
      <legend align="center">
      Marks   details </legend>
      <form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
        <table align="center">
          <tr valign="baseline">
            <td nowrap="nowrap" align="right">MarksID:</td>
            <td><input type="text" name="marksID" value="" size="32" /></td>
          </tr>
          <tr valign="baseline">
            <td nowrap="nowrap" align="right">ExamID:</td>
            <td><input type="text" name="examID" value="" size="32" /></td>
          </tr>
          <tr valign="baseline">
          ...
          <tr valign="baseline">
            ...
            <td><input type="text" name="score" value="" size="32" /></td>
          </tr>
          <tr valign="baseline">
          ...
          <tr valign="baseline">
            <td nowrap="nowrap" align="right">TermID:</td>
            <td><input type="text" name="termID" value="" size="32" /></td>
          </tr>
          <tr valign="baseline">
