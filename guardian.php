...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO guardian (guardianID, guardianname, contact) VALUES (%s, %s, %s)",
                       GetSQLValueString($_POST['guardianID'], "text"),
                       GetSQLValueString($_POST['guardianname'], "text"),
      ...
      Guardian   details </legend>
       ...
       <form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
        <table align="center">
          ...
          <tr valign="baseline">
            <td nowrap="nowrap" align="right">Guardianname:</td>
            <td><input type="text" name="guardianname" value="" size="32" /></td>
          </tr>
          <tr valign="baseline">
