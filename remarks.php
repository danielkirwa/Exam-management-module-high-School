...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO remarks (remarkID, teacherno, remarks, gradingID) VALUES (%s, %s, %s, %s)",
                       GetSQLValueString($_POST['remarkID'], "text"),
...
<table width="100%" height="400" bgcolor="#ffffff">
  <tr>
    <td><fieldset>
      <legend align="center">
      Remarks   details </legend>
      <form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
        <table align="center">
          <tr valign="baseline">
            <td nowrap="nowrap" align="right">RemarkID:</td>
            <td><input type="text" name="remarkID" value="" size="32" /></td>
          </tr>
          <tr valign="baseline">
            <td nowrap="nowrap" align="right">Teacherno:</td>
            <td><input type="text" name="teacherno" value="" size="32" /></td>
          </tr>
          <tr valign="baseline">
            <td nowrap="nowrap" align="right">Remarks:</td>
            <td><input type="text" name="remarks" value="" size="32" /></td>
          </tr>
          <tr valign="baseline">
