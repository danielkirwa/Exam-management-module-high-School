...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO exam (examID, examtype, classID, admino, subjectcode) VALUES (%s, %s, %s, %s, %s)",
                       GetSQLValueString($_POST['examID'], "text"),
                       GetSQLValueString($_POST['examtype'], "text"),
    ...
    <td><fieldset>
      ...
      <form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
        <table align="center">
          ...
          <tr valign="baseline">
            <td nowrap="nowrap" align="right">Examtype:</td>
            <td><input type="text" name="examtype" value="" size="32" /></td>
          </tr>
          <tr valign="baseline">
