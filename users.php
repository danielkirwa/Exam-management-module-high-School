...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO users (username, userpassword, priviledges) VALUES (%s, %s, %s)",
                       GetSQLValueString($_POST['username'], "text"),
                       GetSQLValueString($_POST['userpassword'], "text"),
                       GetSQLValueString($_POST['priviledges'], "text"));
    ...
    <td><fieldset>
      ...
      <form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
        <table align="center">
          ...
          <tr valign="baseline">
            <td nowrap="nowrap" align="right">Priviledges:</td>
            <td><input type="text" name="priviledges" value="" size="32" /></td>
          </tr>
          <tr valign="baseline">
