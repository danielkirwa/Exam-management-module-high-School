...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO `year` (yearID, `year`) VALUES (%s, %s)",
                       GetSQLValueString($_POST['yearID'], "int"),
  ...
  <tr>
    <td><fieldset>
      ...
      <form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
        <table align="center">
          <tr valign="baseline">
            <td nowrap="nowrap" align="right">YearID:</td>
            <td><input type="text" name="yearID" value="" size="32" /></td>
          </tr>
          <tr valign="baseline">
