...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO term (termID, termname) VALUES (%s, %s)",
                       GetSQLValueString($_POST['termID'], "text"),
                       GetSQLValueString($_POST['termname'], "text"));
    ...
    <td><fieldset>
      ...
      <form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
        <table align="center">
          ...
          <tr valign="baseline">
            <td nowrap="nowrap" align="right">Termname:</td>
            <td><input type="text" name="termname" value="" size="32" /></td>
          </tr>
          <tr valign="baseline">
